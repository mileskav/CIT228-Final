...
//$mysqli = mysqli_connect("localhost", "root", "", "devforum") or die(mysql_error());
$mysqli = mysqli_connect("localhost", "lisabalbach_kavana7", "CIT200108", "lisabalbach_kavana7") or die(mysql_error());
...
if (mysqli_num_rows($result) == 1) {
	header("Location: discussionMenu.html");
	exit;
} else {
